...
add_getdomains() {
    ...
    if [ "$COUNTRY" == 'russia_inside' ]; then
        EOF_DOMAINS=DOMAINS=https://raw.githubusercontent.com/Qrolll/domains-list/refs/heads/main/Russia/inside-dnsmasq-nfset.lst
    elif [ "$COUNTRY" == 'russia_outside' ]; then
        EOF_DOMAINS=DOMAINS=https://raw.githubusercontent.com/Qrolll/domains-list/refs/heads/main/Russia/outside-dnsmasq-nfset.lst
